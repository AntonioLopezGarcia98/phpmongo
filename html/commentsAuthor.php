...
**********/
$authorLength = count($authorArray);
for ($x=0; $x<$authorLength; $x++){
        echo '<li><a href=index.php?command=showPostsCommentedByAuthor&author='.$autorArray[$x].'>'.$authorArray[$x].'</a></li>';
}
